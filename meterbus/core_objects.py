...
class VIFTable(object):
    ...
    lut = {
        ...
        # seconds
        0x12C: (1.0, MeasureUnit.SECONDS, VIFUnitExt.DURATION_SINCE_LAST_READOUT),
        # minutes
        0x12D: (60.0, MeasureUnit.SECONDS, VIFUnitExt.DURATION_SINCE_LAST_READOUT),
        # hours
        0x12E: (3600.0, MeasureUnit.SECONDS, VIFUnitExt.DURATION_SINCE_LAST_READOUT),
        # days
        0x12F: (86400.0, MeasureUnit.SECONDS, VIFUnitExt.DURATION_SINCE_LAST_READOUT),
        ...
        # minute(s)
        0x131: (60.0,  MeasureUnit.SECONDS, VIFUnitExt.STORAGE_INTERVAL),
        # hour(s)
        0x132: (3600.0,  MeasureUnit.SECONDS, VIFUnitExt.STORAGE_INTERVAL),
        # day(s)
        0x133: (86400.0,  MeasureUnit.SECONDS, VIFUnitExt.STORAGE_INTERVAL),
        ...
        # month(s)
        0x138: (2629743.83, MeasureUnit.SECONDS, VIFUnitExt.PERIOD_OF_TARIFF),
        # year(s)
        0x139: (31556926.0, MeasureUnit.SECONDS, VIFUnitExt.PERIOD_OF_TARIFF),
        ...
        # hours
        0x168: (3600.0, MeasureUnit.SECONDS, VIFUnitExt.DURATION_SINCE_LAST_CUMULATION),
        # days
        0x169: (86400.0, MeasureUnit.SECONDS, VIFUnitExt.DURATION_SINCE_LAST_CUMULATION),
        # month(s)
        0x16A: (2629743.83, MeasureUnit.SECONDS, VIFUnitExt.DURATION_SINCE_LAST_CUMULATION),
        # year(s)
        0x16B: (31556926.0, MeasureUnit.SECONDS, VIFUnitExt.DURATION_SINCE_LAST_CUMULATION),

        # E110 11pp Operating time battery [hour(s)..years(s)]
        # hours
        0x16C: (3600.0, MeasureUnit.SECONDS, VIFUnitExt.OPERATING_TIME_BATTERY),
        # days
        0x16D: (86400.0, MeasureUnit.SECONDS, VIFUnitExt.OPERATING_TIME_BATTERY),
        # month(s)
        0x16E: (2629743.83, MeasureUnit.SECONDS, VIFUnitExt.OPERATING_TIME_BATTERY),
        # year(s)
        0x16F: (31556926.0, MeasureUnit.SECONDS, VIFUnitExt.OPERATING_TIME_BATTERY),
...
class TelegramDateMasks(object):
